...
// the dev server.
const s_PACKAGE_ID = 'modules/hammergen-foundry-sync-svelte';

// A short additional string to add to Svelte CSS hash values to make yours unique. This reduces the amount of
// duplicated framework CSS overlap between many TRL packages enabled on Foundry VTT at the same time. 'hfss' is chosen
// by shortening 'hammergen-foundry-sync-svelte'.
const s_SVELTE_HASH_ID = 'hfss';
